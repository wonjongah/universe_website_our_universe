...
<div id="wrap">
  ...
  <div id="content">
	...
	<div id="col2">
		...
		<div id="title">
			<img src="../img/title_member_modify.png">
		</div>
		...
		<div id="form_join">
			...
			<li><div id="nick1"><input type="text" name="nick" value="<?= $row[nick] ?>"></div><div id="nick2" ><a href="#"><img src="../img/check.png" onclick="check_nick()"></a></div></li>
