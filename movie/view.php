...
<style>
body div
{cursor: url('../img/oth28.cur'), url('../img/cursor.png'), auto;}
</style>
<script>
...
?>
		...
		<div id="ripple">
<?
	    $sql = "select * from movie_ripple where parent='$item_num'";
...
?>			
			...
			<div id="ripple_box">
				<div id="ripple_box1"><img src="../img/title_comment.png"></div>
				<div id="ripple_box2"><textarea rows="5" cols="65" name="ripple_content"></textarea>
				</div>
				<div id="ripple_box3"><a href="#"><img src="../img/ok.png"  onclick="check_input()"></a></div>
			</div>
			</form>
		</div> <!-- end of ripple -->
