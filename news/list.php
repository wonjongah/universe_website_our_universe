...
<div id="wrap">
  ...
  <div id="content">
	...
	<div id="col2">        
		...
		<div id="list_title">
		<div id="list_title1">  번호</div><div id="list_title2">제목</div>
			      <div id="list_title3">글쓴이</div> <div id="list_title4">등록일</div><div id="list_title5">조회</div>		
		</div>
...
{
?>
<div id="list_item2"> <a href="view.php?table=<?=$table?>&num=<?=$item_num?>&page=<?=$page?>"><b><font color = "#5252c7">[공지] <?= $item_subject ?></a></b></font>
<?
}
else
{
