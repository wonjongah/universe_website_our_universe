...
<body>
    ...
    <table width=250 height=250 border='0' cellspacing='0' cellpadding='0'>
        ...
        <tr>
          ...
          <td></td>
          <td valign=middle><b>1월에 가보고 싶은 천문 장소</b></td>
          <td></td>
        ...
        <tr>
          ...
          <td></td>
          <td> 송암스페이스센터 (<b><? echo $ans1_percent ?></b> %)
...
?>
        ...
        <tr>
          <td height=20 bgcolor='#ffffff'></td>
          <td></td>
          <td> 중미산천문대 (<b><? echo $ans2_percent ?></b> %)
...
?>
        ...
        <tr>
          <td height=20 bgcolor='#ffffff'></td>
          <td></td>
          <td> 보현산천문대 (<b><? echo $ans3_percent ?></b> %)
...
?>
        ...
        <tr>
          <td height=20 bgcolor='#ffffff'></td>
          <td></td>
          <td> 자연과별가평천문대 (<b><? echo $ans4_percent ?></b> %)
